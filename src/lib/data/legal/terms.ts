import type { TermsContent, SupportedLocale } from './types';

export const termsContent: Record<SupportedLocale, TermsContent> = {
  "vi": {
    "sec1": {
    ...
    "sec2": {
      ...
      "services": [
        {
          "label": "Viết phần mềm may đo (Custom Software)",
          "text": "Thiết kế, phát triển các phần mềm web, mobile app, hệ thống vi dịch vụ (Microservices), cổng thanh toán và nền tảng quản trị số hóa theo đặc thù nghiệp vụ của từng khách hàng."
        },
        {
          "label": "Phát triển hệ thống ERP cho doanh nghiệp",
          "text": "Tư vấn kiến trúc, triển khai hệ thống quản trị nguồn lực doanh nghiệp (sản xuất, kho vận WMS, chuỗi cung ứng, kế toán VAS/IFRS, quản lý nhân sự, bán hàng đa kênh)."
        },
        {
          "label": "Cho thuê nhân sự IT cho doanh nghiệp",
          "text": "Cung ứng kỹ sư IT chuyên nghiệp làm việc trực tiếp (Onsite) tại văn phòng khách hàng hoặc làm việc từ xa (Dedicated Remote Team) theo dự án hoặc định kỳ hàng tháng."
        },
        {
          "label": "Máy phun tinh dầu thông minh",
          "text": "Cung cấp, lắp đặt và bảo trì hệ thống máy khuếch tán tinh dầu công nghiệp kết nối HVAC tòa nhà, showroom diện tích lớn và thiết bị thông minh điều khiển qua App/WiFi."
        },
        {
          "label": "Tinh dầu thiên nhiên nguyên chất",
          "text": "Cung cấp các dòng tinh dầu thiên nhiên 100% nguyên chất có đầy đủ chứng nhận nguồn gốc xuất xứ (COA), phiếu kiểm nghiệm GC-MS phục vụ giải pháp tiếp thị bằng mùi hương (Scent Marketing)."
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "Phần mềm & ERP",
          "text": "Thanh toán theo các mốc: Đặt cọc triển khai (30%), Hoàn thành Prototype & Alpha (30%), UAT thử nghiệm & Đào tạo (30%), Quyết toán nghiệm thu bàn giao chính thức (10%)."
        },
        {
          "label": "Thuê nhân sự IT",
          "text": "Quyết toán và xuất hóa đơn định kỳ vào cuối mỗi tháng làm việc theo bảng chấm công (Timesheet) đã được đại diện khách hàng xác nhận."
        },
        {
          "label": "Máy phun & Tinh dầu",
          "text": "Thanh toán theo từng đơn hàng hoặc hợp đồng cung ứng định kỳ, có xuất hóa đơn GTGT (VAT) điện tử hợp lệ theo quy định pháp luật."
        }
      ]
    },
    "sec6": {
  ...
  "en": {
      ...
      "services": [
        {
          ...
          "text": "Design and deployment of bespoke web platforms, mobile apps, microservices infrastructure, secure payment gateways, and enterprise digital operations software."
        },
        {
          "label": "Enterprise ERP Solutions",
          "text": "Architectural design, implementation, and roll-out of unified Enterprise Resource Planning suites (production MRP, WMS warehouse logistics, VAS/IFRS accounting, HR, omnichannel commerce)."
        },
        {
          "label": "Enterprise IT Staffing",
          "text": "Provision of verified professional IT engineers working onsite at client offices or via dedicated remote engineering pods."
        },
        {
          "label": "Smart Commercial Scent Diffusers",
          "text": "Distribution, installation, and preventative maintenance of commercial HVAC-integrated aroma diffusers and smart WiFi/App controllable devices."
        },
        {
          "label": "100% Pure Natural Essential Oils",
          "text": "Supply of pure natural essential oils accompanied by international Certificates of Analysis (COA) and GC-MS chromatography profiles for commercial scent marketing."
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "Software & ERP Engineering",
          "text": "Structured milestone billing: Implementation deposit (30%), Prototype & Alpha delivery (30%), UAT & Training (30%), Final handover acceptance (10%)."
        },
        {
          "label": "IT Staffing Services",
          "text": "Settled and invoiced on a recurring monthly cycle based on validated client timesheets."
        },
        {
          "label": "Hardware & Essential Oils",
          "text": "Settled per order or periodic procurement contracts, accompanied by valid electronic Value-Added Tax (VAT) invoices."
        }
      ]
    },
    "sec6": {
  ...
  "zh": {
    ...
    "sec2": {
      ...
      "services": [
        {
          "label": "定制软件工程开发 (Custom Software)",
          "text": "采用 Rust、Go、Svelte 等现代化高性能架构，为客户度身定制 Web 平台、原生 App、微服务集群、安全支付网关及数字化运营系统。"
        },
        {
          "label": "企业级 ERP 架构开发与部署",
          "text": "提供一体化企业资源计划系统（覆盖生产排程 MRP、WMS 智能仓储、供应链协同、VAS/IFRS 双准则财务核算、HR 人力资源及全渠道营销）。"
        },
        {
          "label": "IT 人才派遣与驻场技术支持 (IT Staffing)",
          "text": "提供资深高级工程师 Onsite 现场驻场服务或专属离岸远程工程开发团队（Dedicated Squads）。"
        },
        {
          "label": "智能商用香氛扩香设备系统",
          "text": "供应、安装及运维支持大型楼宇中央空调（HVAC）管道接入型扩香机、展厅独立设备及支持 App/WiFi 云端控制的智能硬件。"
        },
        {
          "label": "100% 纯天然药典级植物精油",
          "text": "供应具备完整国际 COA 成分检测报告和 GC-MS 气相色谱质谱验证的高品质纯精油，赋能企业空间嗅觉营销。"
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "软件与 ERP 定制工程",
          "text": "分阶段结算：项目启动首付款 (30%)、原型与 Alpha 测试交付款 (30%)、UAT 验收与培训款 (30%)、终验结算款 (10%)。"
        },
        {
          "label": "IT 人才派遣与驻场服务",
          "text": "按自然月定期结算，依据客户授权代表签字确认的工时表（Timesheet）开具账单。"
        },
        {
          "label": "硬件设备与精油耗材",
          "text": "依订单逐笔结算或签署定期采购协议，依法开具越南增值税（VAT）正规电子发票。"
        }
      ]
    },
    "sec6": {
  ...
  "ja": {
    ...
    "sec2": {
      ...
      "services": [
        {
          "label": "カスタムソフトウェア受託開発",
          "text": "Rust、Go、Svelteなどの高性能技術を活用し、お客様固有の業務要件に合わせたWebアプリケーション、モバイルアプリ、マイクロサービス基盤、決済ゲートウェイ、DX管理プラットフォームの設計・開発。"
        },
        {
          "label": "エンタープライズERPシステム",
          "text": "製造MRP、WMS倉庫物流、サプライチェーン、VAS/IFRSデュアル会計、人事労務、オムニチャネル販売を含む統合基幹業務システムの設計コンサルティングおよび導入展開。"
        },
        {
          "label": "ITエンジニア派遣・専属チーム提供",
          "text": "厳格な審査を経たシニアエンジニアによるお客様オフィスへの常駐（Onsite）または専属リモート開発チーム（Dedicated Remote Squads）の提供。"
        },
        {
          "label": "スマートアロマディフューザー機器",
          "text": "ビル中央空調（HVAC）連動型業務用ディフューザー、大規模ショールーム向け独立機、およびクラウド/WiFi対応スマート機器の供給・設置・保守管理。"
        },
        {
          "label": "100%天然純粋エッセンシャルオイル",
          "text": "国際COA成分分析書およびGC-MSガスクロマトグラフィー検査証を完備した、プロフェッショナル向け香りマーケティング用天然精油の供給。"
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "ソフトウェア＆ERP受託開発",
          "text": "マイルストーン決済：着手金 (30%)、プロトタイプ＆Alpha完成時 (30%)、UAT試験＆研修完了時 (30%)、最終納品検収時 (10%)。"
        },
        {
          "label": "ITエンジニア派遣サービス",
          "text": "お客様承認済みのタイムシート（Timesheet）に基づき、毎月末に精算およびインボイスを発行。"
        },
        {
          "label": "ディフューザー機器および精油",
          "text": "ご注文ごとの精算または定期調達契約に基づき、ベトナム付加価値税（VAT）電子請求書を発行。"
        }
      ]
    },
    "sec6": {
  ...
  "ko": {
    ...
    "sec2": {
      ...
      "services": [
        {
          "label": "맞춤형 소프트웨어 수주 개발 (Custom Software)",
          "text": "Rust, Go, Svelte 등 고성능 아키텍처를 기반으로 고객 비즈니스 요구에 맞춘 웹 플랫폼, 모바일 앱, 마이크로서비스, 결제 게이트웨이 및 DX 운영 시스템 구축."
        },
        {
          "label": "엔터프라이즈 ERP 시스템 개발",
          "text": "생산 관리 MRP, 스마트 물류 WMS, 공급망 협업, 베트남 VAS/IFRS 이중 회계, 인사 관리 및 옴니채널 판매를 아우르는 통합 ERP 구축."
        },
        {
          "label": "IT 인재 파견 및 상주 아웃소싱 (IT Staffing)",
          "text": "검증된 전문 소프트웨어 엔지니어의 고객 사무실 상주(Onsite) 파견 또는 전담 원격 개발팀(Dedicated Remote Team) 제공."
        },
        {
          "label": "스마트 상업용 디퓨저 장비",
          "text": "중앙 공조(HVAC) 연동 대형 디퓨저, 대형 쇼룸용 독립형 기기 및 Wi-Fi/모바일 앱 연동 스마트 장비 공급·설치·유지보수."
        },
        {
          "label": "100% 천연 순수 에센셜 오일",
          "text": "국제 COA 성분 시험 성적서와 GC-MS 질량 분석 데이터를 완비한 공간 향기 마케팅용 프리미엄 천연 에센셜 오일 공급."
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "소프트웨어 및 ERP 수주 개발",
          "text": "단계별 분할 결제: 계약금 (30%), 프로토타입/알파 납품 (30%), UAT 검수/교육 완료 (30%), 최종 잔금 (10%)."
        },
        {
          "label": "IT 인재 파견 서비스",
          "text": "고객 승인 타임시트(Timesheet)에 기반하여 매월 말 정기 정산 및 인보이스 발행."
        },
        {
          "label": "디퓨저 하드웨어 및 에센셜 오일",
          "text": "주문별 정산 또는 정기 공급 계약에 따르며, 베트남 공식 부가가치세(VAT) 전자세금계산서 발행."
        }
      ]
    },
    "sec6": {
  ...
  "th": {
    ...
    "sec2": {
      ...
      "services": [
        {
          "label": "การพัฒนาซอฟต์แวร์ตามสั่ง (Custom Software)",
          "text": "ออกแบบและพัฒนาระบบเว็บ แอปพลิเคชันมือถือ ไมโครเซอร์วิส เกตเวย์การชำระเงิน และแพลตฟอร์มการจัดการดิจิทัลตามความต้องการเฉพาะของธุรกิจ"
        },
        {
          "label": "การพัฒนาระบบ ERP สำหรับองค์กร",
          "text": "ให้คำปรึกษาด้านสถาปัตยกรรมและวางระบบ ERP ครบวงจร (การผลิต MRP, การจัดการคลังสินค้า WMS, บัญชี VAS/IFRS, ทรัพยากรบุคคล และการขายหลายช่องทาง)"
        },
        {
          "label": "บริการจัดหาบุคลากร IT (IT Staffing)",
          "text": "จัดหาวิศวกร IT มืออาชีพปฏิบัติงานประจำที่สำนักงานลูกค้า (Onsite) หรือทีมพัฒนาเฉพาะทางระยะไกล (Dedicated Remote Team)"
        },
        {
          "label": "เครื่องกระจายกลิ่นน้ำมันหอมระเหยอัจฉริยะ",
          "text": "จำหน่าย ติดตั้ง และบำรุงรักษาระบบกระจายกลิ่นอุตสาหกรรมเชื่อมต่อ HVAC อาคาร โชว์รูมขนาดใหญ่ และอุปกรณ์อัจฉริยะควบคุมผ่านแอป/WiFi"
        },
        {
          "label": "น้ำมันหอมระเหยธรรมชาติบริสุทธิ์ 100%",
          "text": "จัดหาน้ำมันหอมระเหยบริสุทธิ์พร้อมใบรับรองการวิเคราะห์ (COA) และรายงานผล GC-MS สำหรับการตลาดด้วยกลิ่นสัมผัส (Scent Marketing)"
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "ซอฟต์แวร์และ ERP",
          "text": "ชำระเงินตามงวด: เงินมัดจำเริ่มโครงการ (30%), ส่งมอบ Prototype & Alpha (30%), UAT และฝึกอบรม (30%), ตรวจรับมอบงานขั้นสุดท้าย (10%)"
        },
        {
          "label": "บุคลากร IT",
          "text": "ชำระเงินและออกใบแจ้งหนี้เป็นรายเดือนตามใบบันทึกเวลาทำงาน (Timesheet) ที่ได้รับการรับรองจากลูกค้า"
        },
        {
          "label": "เครื่องกระจายกลิ่นและน้ำมันหอมระเหย",
          "text": "ชำระเงินตามคำสั่งซื้อหรือสัญญาจัดซื้อเป็นงวด พร้อมออกใบกำกับภาษีมูลค่าเพิ่ม (VAT) อิเล็กทรอนิกส์ถูกต้องตามกฎหมาย"
        }
      ]
    },
    "sec6": {
  ...
  "lo": {
    ...
    "sec2": {
      ...
      "services": [
        {
          "label": "ການພັດທະນາຊອບແວຕາມສັ່ງ (Custom Software)",
          "text": "ອອກແບບ ແລະ ພັດທະນາເວັບໄຊ, ແອັບມືຖື, ລະບົບ Microservices, ປະຕູຊຳລະເງິນ ແລະ ແພລດຟອມດິຈິຕອນຕາມຄວາມຕ້ອງການສະເພາະ."
        },
        {
          "label": "ການພັດທະນາລະບົບ ERP ສຳລັບທຸລະກິດ",
          "text": "ໃຫ້ຄຳປຶກສາ ແລະ ຕິດຕັ້ງລະບົບ ERP ຄົບວົງຈອນ (ການຜະລິດ MRP, ຄັງສິນຄ້າ WMS, ບັນຊີ VAS/IFRS, ບຸກຄະລາກອນ ແລະ ການຂາຍຫຼາຍຊ່ອງທາງ)."
        },
        {
          "label": "ການສະໜອງບຸກຄະລາກອນ IT (IT Staffing)",
          "text": "ສະໜອງວິສະວະກອນ IT ມືອາຊີບເຮັດວຽກປະຈຳການ (Onsite) ຫຼື ທີມພັດທະນາໄລຍະໄກ (Dedicated Remote Team)."
        },
        {
          "label": "ເຄື່ອງກະຈາຍກິ່ນນ້ຳມັນຫອມລະເຫີຍອັດສະລິຍະ",
          "text": "ສະໜອງ, ຕິດຕັ້ງ ແລະ ບຳລຸງຮັກສາເຄື່ອງກະຈາຍກິ່ນເຊື່ອມຕໍ່ HVAC ອາຄານ, ຫ້ອງວາງສະແດງ ແລະ ອຸປະກອນຄວບຄຸມຜ່ານແອັບ/WiFi."
        },
        {
          "label": "ນ້ຳມັນຫອມລະເຫີຍທຳມະຊາດ 100%",
          "text": "ສະໜອງນ້ຳມັນຫອມລະເຫີຍບໍລິສຸດ ພ້ອມໃບຢັ້ງຢືນ COA ແລະ ຜົນກວດສອບ GC-MS ສຳລັບການຕະຫຼາດດ້ວຍກິ່ນ (Scent Marketing)."
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "ຊອບແວ & ERP",
          "text": "ຊຳລະຕາມງວດ: ເງິນມັດຈຳ (30%), ສົ່ງມອບ Prototype & Alpha (30%), UAT & ຝຶກອົບຮົມ (30%), ກວດຮັບຂັ້ນສຸດທ້າຍ (10%)."
        },
        {
          "label": "ບຸກຄະລາກອນ IT",
          "text": "ສະສາງ ແລະ ອອກໃບແຈ້ງໜີ້ປະຈຳເດືອນຕາມໃບບັນທຶກເວລາ (Timesheet) ທີ່ລູກຄ້າຢັ້ງຢືນ."
        },
        {
          "label": "ອຸປະກອນ & ນ້ຳມັນຫອມລະເຫີຍ",
          "text": "ຊຳລະຕາມແຕ່ລະຄຳສັ່ງຊື້ ພ້ອມອອກໃບກຳກັບພາສີມູນຄ່າເພີ່ມ (VAT) ຖືກຕ້ອງຕາມກົດໝາຍ."
        }
      ]
    },
    "sec6": {
  ...
  "ms": {
    ...
    "sec2": {
      ...
      "services": [
        {
          "label": "Pembangunan Perisian Tersuai (Custom Software)",
          "text": "Reka bentuk dan pembangunan aplikasi web, aplikasi mudah alih, seni bina perkhidmatan mikro (microservices), gerbang pembayaran selamat dan platform operasi digital."
        },
        {
          "label": "Penyelesaian Sistem ERP Perusahaan",
          "text": "Perundingan seni bina dan pelaksanaan sistem ERP bersepadu (pengeluaran MRP, logistik gudang WMS, perakaunan VAS/IFRS, pengurusan HR dan jualan omnisaluran)."
        },
        {
          "label": "Penyumberan Luar Tenaga Kerja IT (IT Staffing)",
          "text": "Membekalkan jurutera IT profesional yang bekerja di tapak (Onsite) pejabat pelanggan atau melalui pasukan kejuruteraan jauh khusus (Dedicated Remote Team)."
        },
        {
          "label": "Peralatan Peresap Minyak Pati Pintar",
          "text": "Pembekalan, pemasangan dan penyelenggaraan sistem peresap aroma industri bersepadu HVAC bangunan, bilik pameran dan peranti pintar dikawal melalui Aplikasi/WiFi."
        },
        {
          "label": "Minyak Pati Asli 100% Tulen",
          "text": "Membekalkan minyak pati semula jadi tulen dengan Sijil Analisis (COA) antarabangsa dan profil kromatografi GC-MS untuk pemasaran aroma komersial."
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "Perisian & Kejuruteraan ERP",
          "text": "Pembayaran mengikut peringkat: Deposit permulaan (30%), Penyerahan Prototaip & Alpha (30%), UAT & Latihan (30%), Penyerahan muktamad (10%)."
        },
        {
          "label": "Perkhidmatan Tenaga Kerja IT",
          "text": "Diselesaikan dan diinvois setiap bulan berdasarkan helaian masa (Timesheet) yang disahkan oleh pelanggan."
        },
        {
          "label": "Perkakasan & Minyak Pati",
          "text": "Diselesaikan bagi setiap pesanan atau kontrak perolehan berkala, disertakan invois Cukai Nilai Tambah (VAT) elektronik yang sah."
        }
      ]
    },
    "sec6": {
  ...
  "es": {
      ...
      "services": [
        {
          ...
          "text": "Diseño y despliegue de plataformas web, aplicaciones móviles, microservicios, pasarelas de pago y sistemas de operaciones digitales empresariales."
        },
        {
          "label": "Desarrollo de Sistemas ERP Empresariales",
          "text": "Consultoría e implantación de sistemas ERP integrales (producción MRP, logística WMS, contabilidad VAS/IFRS, recursos humanos y ventas omnicanal)."
        },
        {
          "label": "Externalización y Selección de Talento TI",
          "text": "Provisión de ingenieros de software cualificados trabajando en las instalaciones del cliente (Onsite) o en equipos remotos dedicados."
        },
        {
          "label": "Difusores Inteligentes de Aromas",
          "text": "Venta, instalación y mantenimiento de sistemas industriales de difusión de aromas integrados en HVAC y equipos inteligentes controlados por App/WiFi."
        },
        {
          "label": "Aceites Esenciales 100% Puros y Naturales",
          "text": "Suministro de aceites botánicos puros con Certificados de Análisis (COA) internacionales y cromatografía GC-MS para marketing olfativo corporativo."
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "Software e Ingeniería ERP",
          "text": "Facturación por hitos: Anticipo de inicio (30%), Entrega de Prototipo y Alpha (30%), Aceptación UAT y formación (30%), Liquidación final (10%)."
        },
        {
          "label": "Servicios de Personal TI",
          "text": "Facturación periódica mensual basada en partes de horas (Timesheets) validados por el cliente."
        },
        {
          "label": "Equipos y Aceites Esenciales",
          "text": "Pago por pedido o contratos de suministro periódico, con emisión de factura electrónica de IVA oficial de Vietnam."
        }
      ]
    },
    "sec6": {
  ...
  "fr": {
      ...
      "services": [
        {
          ...
          "text": "Conception de plateformes web, applications mobiles, architectures microservices, passerelles de paiement sécurisées et logiciels opérationnels."
        },
        {
          "label": "Déploiement de Systèmes ERP d'Entreprise",
          "text": "Conseil en architecture et intégration d'ERP (production MRP, gestion d'entrepôt WMS, comptabilité VAS/IFRS, RH et vente omnicanale)."
        },
        {
          "label": "Délégation de Compétences IT (Régie & Équipes Dédiées)",
          "text": "Mise à disposition d'ingénieurs qualifiés intervenant sur site (Onsite) ou au sein d'équipes de développement à distance dédiées."
        },
        {
          "label": "Diffuseurs de Parfum Professionnels Connectés",
          "text": "Fourniture, installation et maintenance de diffuseurs industriels raccordés aux réseaux de climatisation HVAC et appareils connectés WiFi/App."
        },
        {
          "label": "Huiles Essentielles 100% Pures & Naturelles",
          "text": "Fourniture d'huiles essentielles pures certifiées avec certificats d'analyse (COA) et profils chromatographiques GC-MS pour le marketing olfactif."
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "Ingénierie Logicielle & ERP",
          "text": "Facturation par jalons : Acompte de démarrage (30%), Livraison Prototype & Alpha (30%), Validation UAT & Formation (30%), Solde de recette définitive (10%)."
        },
        {
          "label": "Prestations d'Ingénierie IT",
          "text": "Facturation mensuelle récurrente sur la base des relevés d'heures (Timesheets) approuvés par le client."
        },
        {
          "label": "Matériel & Huiles Essentielles",
          "text": "Règlement à la commande ou contrat d'approvisionnement régulier avec facture électronique TVA vietnamienne conforme."
        }
      ]
    },
    "sec6": {
  ...
  "hi": {
    ...
    "sec2": {
      ...
      "services": [
        {
          "label": "कस्टम सॉफ्टवेयर इंजीनियरिंग",
          "text": "वेब प्लेटफॉर्म, मोबाइल ऐप, माइक्रोसर्विसेज आर्किटेक्चर, सुरक्षित भुगतान गेटवे और डिजिटल संचालन प्रबंधन सॉफ्टवेयर का निर्माण।"
        },
        {
          "label": "एंटरप्राइज़ ईआरपी सिस्टम विकास",
          "text": "एकीकृत ईआरपी सिस्टम का परामर्श और कार्यान्वयन (उत्पादन एमआरपी, डब्लूएमएस वेयरहाउस लॉजिस्टिक्स, वीएएस/आईएफआरएस लेखांकन, एचआर और ओमनीचैनल बिक्री)।"
        },
        {
          "label": "आईटी स्टाफिंग और विशेषज्ञ टीम आउटसोर्सिंग",
          "text": "ग्राहक कार्यालय में ऑन-साइट या समर्पित रिमोट इंजीनियरिंग टीमों के माध्यम से योग्य सॉफ्टवेयर इंजीनियरों की आपूर्ति।"
        },
        {
          "label": "स्मार्ट वाणिज्यिक डिफ्यूज़र उपकरण",
          "text": "एचवीएसी केंद्रीय एयर कंडीशनिंग से जुड़े औद्योगिक डिफ्यूज़र, शोरूम उपकरण और ऐप/वाईफाई नियंत्रित स्मार्ट हार्डवेयर की आपूर्ति और रखरखाव।"
        },
        {
          "label": "100% शुद्ध प्राकृतिक आवश्यक तेल",
          "text": "अंतरराष्ट्रीय सीओए प्रमाणपत्र और जीसी-एमएस क्रोमैटोग्राफी प्रोफाइल के साथ वाणिज्यिक खुशबू विपणन के लिए प्रीमियम प्राकृतिक आवश्यक तेल।"
        }
      ]
    },
    "sec3": {
    ...
    "sec5": {
      ...
      "items": [
        {
          "label": "सॉफ्टवेयर और ईआरपी इंजीनियरिंग",
          "text": "चरणबद्ध भुगतान: परियोजना प्रारंभ अग्रिम (30%), प्रोटोटाइप/अल्फा वितरण (30%), यूएटी परीक्षण और प्रशिक्षण (30%), अंतिम समापन (10%)।"
        },
        {
          "label": "आईटी स्टाफिंग सेवाएं",
          "text": "ग्राहक द्वारा सत्यापित टाइमशीट के आधार पर मासिक आधार पर बिलिंग और चालान।"
        },
        {
          "label": "हार्डवेयर और आवश्यक तेल",
          "text": "प्रति ऑर्डर या आवधिक आपूर्ति अनुबंधों के अनुसार भुगतान, वैध वियतनाम वैट इलेक्ट्रॉनिक चालान के साथ।"
        }
      ]
    },
    "sec6": {
